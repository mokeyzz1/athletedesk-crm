...
export default function ContractsPage() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setPageError('Failed to upload document. Please try again.')
    } finally {
  ...
  const handleDownload = async (doc: DocumentWithAthlete) => {
    try {
      ...
      if (downloadError) {
        ...
        setPageError('Document not available for download.')
        return
      }
      ...
      setPageError('Failed to download document. Please try again.')
    }
  }
