...
export const drawerNavItems: NavItem[] = [
  ...
  { name: 'Productivity', href: '/team/productivity', icon: 'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z', adminOnly: true },
  { name: 'Settings', href: '/settings', icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z' },
]

export const bottomNavItems: NavItem[] = [
  drawerNavItems[0], // Dashboard
  drawerNavItems[1], // Athletes
  drawerNavItems[3], // Tasks
  drawerNavItems[5], // Email
  drawerNavItems[10], // Settings
]

const titleMap: { prefix: string; title: string }[] = [
  { prefix: '/athletes', title: 'Athletes' },
  { prefix: '/recruiting', title: 'Recruiting' },
  ...
  { prefix: '/email', title: 'Inbox' },
  { prefix: '/brands', title: 'Brands' },
  { prefix: '/financials', title: 'Financials' },
  { prefix: '/contracts', title: 'Contracts' },
  { prefix: '/settings', title: 'Settings' },
  { prefix: '/team/productivity', title: 'Productivity' },
  { prefix: '/team/weekly', title: 'Weekly View' },
